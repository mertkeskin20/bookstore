<template>
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-6">
        <div class="image-box">
          <img class="img-fluid" src="../../template/images/about-img.png" />
        </div>
      </div>
      <div class="col-md-6">
      ...
      <div class="col-md-6">
        <div class="box">
          ...
          <router-link v-else to="/login">
            <p style="color: var(--secondary-color)">Log in to rate</p>
          </router-link>
        </div>
      </div>
    </div>
    ...
    <div class="row mt-3">
      <div class="col-md-12">
        <div class="box">
          ...
          <router-link v-else to="/login">
            <p style="color: var(--secondary-color)">Log in to comment</p>
          </router-link>
        </div>
      </div>
    </div>
