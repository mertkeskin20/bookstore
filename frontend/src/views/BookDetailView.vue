<template>
    <section>
        <div class="container" v-if="!loading">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <img src="../../template/images/about-img.png" class="card-img-top">
                </div>
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.
                                     Adipisci labore, nobis temporibus cum vero laboriosam?</p>
                                <div class="d-flex justify-content-between">
                                    <p class="fw-bold fst-italic">Mert KESKİN</p>
